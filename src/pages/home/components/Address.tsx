        ...
        <div className="pt-[140px]">
            ...
            <div className="flex flex-row items-center justify-between w-[100%] mb-[64px]">
                <div className="flex flex-row items-center">
                    <div className="w-[24px] h-[24px] rounded-full  bg-black text-white text-center mr-[8px]">1</div>
                    <h1 className="leading-6 font-sans text-[16px] font-normal">寄送地址</h1>
                </div>
                <div className="w-[60px] h-[1px] bg-black box-border" />
                <div className="flex flex-row items-center">
                    <div className="w-[24px] h-[24px] rounded-full border border-slate-400 text-slate-400 text-center mr-[8px]">2</div>
                    <h1 className="leading-6 font-sans text-[16px] font-normal  text-slate-400">運送方式</h1>
                </div>
                <div className="w-[60px] h-[1px] bg-black box-border" />
                <div className="flex flex-row items-center">
                    <div className="w-[24px] h-[24px] rounded-full border border-slate-400 text-slate-400 text-center mr-[8px]">3</div>
